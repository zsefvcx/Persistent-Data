...
class FakeData {
  ...
  static Future<void> createFake() async {
    ...
    groups.add(
      Photo(id: null, name:   'Movies', image: url, locator: uuid),
    );
    ...
    groups.add(
      Photo(id: null, name:   'Series', image: url, locator: uuid),
    );

    url = 'https://s00.yaplakal.com/pics/pics_preview/1/3/5/18424531.jpg';
    (_ , uuid) = await PhotoReadFromIntFile().writeCounter(url);
    groups.add(
      Photo(id: null, name:   'Games', image: url, locator: uuid),
    );

    url = 'https://s00.yaplakal.com/pics/pics_preview/2/4/2/18424242.jpg';
    (_ , uuid) = await PhotoReadFromIntFile().writeCounter(url);
    groups.add(
      Photo(id: null, name:   'TV Shows', image: url, locator: uuid),
    );
